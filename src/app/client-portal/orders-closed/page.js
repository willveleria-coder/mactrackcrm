    ...
    <div className="min-h-screen bg-gradient-to-br from-[#f0f7ff] via-[#ffffff] to-[#e8f4ff] flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl shadow-2xl p-8 sm:p-12 max-w-lg w-full text-center border border-gray-100">
        ...
        <div className="bg-blue-50 border-2 border-blue-200 rounded-2xl p-6 mb-6">
          ...
          <Link href="/client-portal/new-order?bypass=mac123&scheduled=true" className="inline-block bg-gradient-to-r from-blue-500 to-blue-600 text-white px-8 py-4 rounded-xl font-black text-lg hover:from-blue-600 hover:to-blue-700 transition shadow-lg">
            Schedule a Booking
          </Link>
        </div>
        ...
        <Link href="/client-portal/dashboard" className="inline-block px-6 py-3 bg-gray-200 text-gray-700 rounded-xl font-bold hover:bg-gray-300 transition">
          Back to Dashboard
        </Link>
      </div>
    </div>
