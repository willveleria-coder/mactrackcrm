    ...
    <div class="label">
      <div class="header">
        <div class="header-left">
          ...
          <div><div class="brand-name">MAC TRACK</div><div class="brand-sub">Courier Service</div></div>
        </div>
...
function StatusBadge({ status }) {
  const styles = { pending: "bg-yellow-100 text-yellow-700 border-yellow-300", active: "bg-blue-100 text-blue-700 border-blue-300", delivered: "bg-green-100 text-green-700 border-green-300", cancelled: "bg-red-100 text-red-700 border-red-300" };
  return <span className={`inline-block px-2 sm:px-3 py-1 sm:py-1.5 rounded-full text-xs font-bold capitalize border-2 ${styles[status] || "bg-gray-100 text-gray-600 border-gray-300"}`}>{status}</span>;
}